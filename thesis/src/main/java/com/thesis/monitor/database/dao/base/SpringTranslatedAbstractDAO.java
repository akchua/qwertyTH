package com.thesis.monitor.database.dao.base;
...
/**
 * A translated DAO that uses spring DAO support to open and release a hibernate session. 
 * 
 ...
 */
public abstract class SpringTranslatedAbstractDAO<T extends IEntity<ID>, ID extends Serializable>
		extends TranslatedAbstractDAO<T, ID>
{
	 ...
	 */
	public SpringTranslatedAbstractDAO(Class<T> clazz, Order... orders)
	 ...
	 * @throws IllegalArgumentException
	 */
	public SpringTranslatedAbstractDAO(Order... orders)
			throws NullPointerException, IllegalArgumentException
	{
		super(orders);
	}
