define(['plugins/router', 'durandal/app', 'modules/securityservice', 'modules/accountservice', 'viewmodels/admin/accountSettings'], function (router, app, securityService, accountService, accountSettings) {
	var homeroute = [
